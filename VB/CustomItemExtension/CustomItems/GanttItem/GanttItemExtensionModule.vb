...
Namespace DevExpresss.DashboardWin.CustomItemExtension
	...
	Public Class GanttItemExtensionModule
		...
		Public Sub AttachDesigner(ByVal designer As DashboardDesigner) Implements IExtensionModule.AttachDesigner
			...
			designer.CreateCustomItemBars(GetType(GanttItemMetadata))
		...
		Private Sub OnCustomDashboardItemControlCreating(ByVal sender As Object, ByVal e As CustomDashboardItemControlCreatingEventArgs)
			If e.MetadataType Is GetType(GanttItemMetadata) Then
				e.CustomControlProvider = New GanttItemControlProvider(TryCast(dashboardControl.Dashboard.Items(e.DashboardItemName), CustomDashboardItem(Of GanttItemMetadata)))
			End If
		End Sub
		Private Sub RemoveDrillDownBarItem(ByVal designer As DashboardDesigner)
			Dim page As RibbonPage = designer.Ribbon.GetDashboardRibbonPage(GetType(GanttItemMetadata), DashboardRibbonPage.Data)
